  ...
  return (
    <div className="container mx-auto px-4 mt-12 lg:mt-24">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        {/* Left Column - Sticky */}
        <div className="lg:sticky lg:top-24 lg:self-start lg:h-auto">
        ...
        <div className="space-y-24">
          ...
          <section id="projects" className="lg:pl-6 space-y-8 scroll-mt-20">
            ...
            <p className="mb-8">
              Below are some notable projects I've had the pleasure of working on throughout my
              career. Each represents unique challenges and learning opportunities that have shaped
